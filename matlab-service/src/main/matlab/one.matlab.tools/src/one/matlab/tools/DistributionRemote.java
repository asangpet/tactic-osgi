...
/**
 * The <code>DistributionRemote</code> class provides a Java RMI-compliant interface to 
 * the M-functions from the files:
 * <pre>
 *  D:\\workspace\\tactic\\matlab-service\\src\\main\\matlab\\dist_gevpdf.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>DistributionRemote</code> 
 ...
 * generate RMI server proxy objects for instances of one.matlab.tools.Distribution.
 */
public interface DistributionRemote extends Poolable
{
    /**
     ...
     */
    public Object[] dist_gevpdf(int nargout, Object... rhs) throws RemoteException;
